...
def test_place_market_order():
    ...
    response = place_market_order(mock_client, "ETHUSDT", "BUY", "0.05")
...
def test_place_limit_order():
    ...
    response = place_limit_order(mock_client, "BTCUSDT", "SELL", "0.1", "50000")
...
def test_place_stop_market_order():
    ...
    response = place_stop_market_order(mock_client, "BTCUSDT", "SELL", "0.1", "40000")
